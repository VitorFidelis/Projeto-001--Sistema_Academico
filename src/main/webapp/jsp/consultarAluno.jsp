...
<link rel="stylesheet" type="text/css" href="css/ConsultarAluno.css" media="screen" />
		...
		<input type="hidden" name="cmd" value="incluir">
		  <div class="col-md-3">
			  ...
			  <div class="col-md-3">
			  	...
			  	<input type="text" class="form-control"id="inputPeriodo" name="txtIdade" value="<%=aluno.getPeriodo()%>" readonly="readonly" />
		</form>
	</div>
	<!--End Form-->
</body>
